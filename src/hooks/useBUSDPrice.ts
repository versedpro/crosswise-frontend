import { ChainId, Currency, currencyEquals, JSBI, Price, WETH } from '@crosswise/sdk'
import { useMemo } from 'react'
import useActiveWeb3React from 'hooks/useActiveWeb3React'
import { BUSD, CRSS } from '../config/constants/tokens'
...
export const useCakeBusdPrice = (): Price | undefined => {
  ...
  const cakeBusdPrice = useBUSDPrice(CRSS[currentChaindId])
