...
import { Box, Button, Flex, InjectedModalProps, LinkExternal, Message, Text } from '@crosswise/uikit'
  ...
  return (
    <>
      ...
      <Flex alignItems="center" justifyContent="space-between" mb="24px">
        <Text color="textSubtle">{t('CRSS Balance')}</Text>
        <Text>{getFullDisplayBalance(crssBalance, 18, 3)}</Text>
      </Flex>
