    ...
    <>
      ...
      <SettingHeaderLayout>
        <SettingsHeadCard isDarkTheme={isDark}>
         <Text fontSize="20px" color="text">Wallet Settings</Text>
         <div style={{marginTop: '45px'}}>
            <Text fontSize="13px" color="textSecondary">Wallet address</Text>
            <div style={{display: 'flex', alignItems: 'baseline'}}>
            <Text fontSize="16px" color="textSecondary">{showAddress(account)}</Text>
              {account && (
        ...
        <SettingsHeadCard isDarkTheme={isDark}>
         <div style={{display:'flex', justifyContent: 'space-between'}}>
           ...
           <div style={{display:'flex', flexDirection:'column', width:'45%'}}>
            <Text fontSize="20px" color="text">Wallet Settings</Text>
            <div>
              <Text color="textSecondary" fontSize="13px">Username:</Text>
              <Input type="text" placeholder="" scale="md"/>
            </div>
            <div style={{display:'flex', alignItems:'center', paddingTop:'24px', paddingBottom: '24px'}}>
              <Checkbox scale="sm" />
              <Text paddingLeft="16px" fontSize="14px" color="textSecondary">Set email address for notifications</Text>
            </div>
            ...
            <div style={{display:'flex', alignItems:'center', paddingTop:'24px', paddingBottom: '24px'}}>
              ...
              <Text paddingLeft="16px" fontSize="14px" color="textSecondary">Set Telegram nickname for notifications</Text>
            </div>
            ...
            <div style={{display:'flex', alignItems:'center', paddingTop:'24px', paddingBottom: '24px'}}>
              <Checkbox scale="sm" checked />
              <Text paddingLeft="16px" fontSize="14px" color="textSecondary">Get Notifications</Text>
            </div>
           </div>
           {/* Left block end */}
           ...
           {/* Right block start */}
           <div style={{display:'flex', flexDirection:'column', width:'45%'}}>
           <Text fontSize="20px" color="text">DEX Settings</Text>
            <div style={{display:'flex', alignItems:'center', paddingTop:'24px'}}>
              <Checkbox scale="sm" />
              <Text paddingLeft="16px" fontSize="14px" color="textSecondary">Gassless mode</Text>
            </div>

            <div style={{display:'flex', alignItems:'center', paddingTop:'24px'}}>
              <Checkbox scale="sm" checked/>
              <Text paddingLeft="16px" fontSize="14px" color="textSecondary">Auto Vesting (burn 50% XCRSS and get it directly as CRSS</Text>
            </div>

            <div style={{display:'flex', alignItems:'center', paddingTop:'24px'}}>
              <Checkbox scale="sm" checked/>
              <Text paddingLeft="16px" fontSize="14px" color="textSecondary">Auto Compaund (5% performance fee)</Text>
            </div>
