...
import { Modal, Text, Flex, Image, Button, Slider, BalanceInput, AutoRenewIcon } from '@crosswise/uikit'
...
const VaultStakeModal: React.FC<VaultStakeModalProps> = ({ pool, stakingMax, isRemovingStake = false, onDismiss }) => {
  ...
  const usdValueStaked =
    crssPriceBusd.gt(0) && stakeAmount ? formatNumber(new BigNumber(stakeAmount).times(crssPriceBusd).toNumber()) : ''
  ...
  return (
    ...
    >
      ...
      <BalanceInput
        ...
        currencyValue={crssPriceBusd.gt(0) && `~${usdValueStaked || 0} USD`}
